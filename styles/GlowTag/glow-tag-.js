...
(function() {
    ...
    function createGlowTagStyles() {
        var styles = `
            ...
            .angel-wings {
                ...
                width: 100%;
                height: 100%;
                background: url('https://example.com/angel-wings.png') no-repeat center;
    ...
    const GlowTag = /** @class */ (function (_super) {
        ...
        GlowTag.prototype.connectedCallback = function () {
            ...
            this.appendChild(this.createWings()); // Add wings to the glow tag
        };
        GlowTag.prototype.createWings = function () {
            var wings = document.createElement('div');
            wings.classList.add('angel-wings');
            return wings;
        };
    ...
    function randomBlur() {
        var blurAmount = getRandomInt(1, 4); // Random blur amount between 1 and 4 pixels
        var duration = getRandomInt(15000, 25000); // Random duration between 15 and 25 seconds
    ...
    // Call the randomBlur function at set intervals
    setInterval(randomBlur, 142857); // Adjusted to a reasonable interval
    setInterval(randomBlur, 42857); // Adjusted to a reasonable interval
    setInterval(randomBlur, 2857); // Adjusted to a reasonable interval
